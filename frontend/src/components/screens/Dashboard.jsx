                ...
                {(recentReports || []).map((r) => {
                  ...
                  return (
                    <tr key={r.report_id}>
                      ...
                      <td style={{ fontSize: '10px', color: 'var(--muted)' }}>
                        {formatRelativeTime(r.reported_at)}
                      </td>
                      <td>
                        <button
        ...
        <div className="card">
          ...
          <div style={{ padding: '10px 14px' }}>
            {(stats?.recent_activity || []).map((a, i) => {
              ...
              const entityType = (a.entity_type || '').toLowerCase();
              const isClickable = !!a.entity_id && (entityType === 'report' || entityType === 'case');
              const dotColor =
                severity === 'success'
                  ? 'var(--success)'
                  : severity === 'danger'
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '10px', color: 'var(--muted)', marginTop: 2 }}>
                    {formatRelativeTime(a.created_at)}{isClickable ? ' · Click to open' : ''}
                  </div>
                </div>
              </div>
            )})}
